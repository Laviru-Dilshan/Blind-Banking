            ...
            SelectNames(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CustomFormScreen(selectedBankName: 'BOC'),
                  ),
                );
              },
            ),
            ...
            SelectNames(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CustomFormScreen(selectedBankName: 'NSB'),
                  ),
                );
              },
            ),
            ...
            SelectNames(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CustomFormScreen(selectedBankName: 'Peoples Bank'),
                  ),
                );
              },
            ),
            ...
            SelectNames(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CustomFormScreen(selectedBankName: 'Sampath Bank'),
                  ),
                );
              },
            ),
...
class SelectNames extends StatelessWidget {
  final IconData icon;
  final String name;
